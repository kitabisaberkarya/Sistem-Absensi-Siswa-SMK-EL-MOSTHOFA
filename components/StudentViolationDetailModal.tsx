...
import { X, Calendar, User, FileText, AlertTriangle, Download, Mail, Phone, MapPin, Hash, CheckCircle2, History, Copy } from 'lucide-react';
...
// WhatsApp Logo SVG Component for Branding
...
export const StudentViolationDetailModal: React.FC<Props> = ({ isOpen, onClose, student, riskStatus = 'Aman' }) => {
  ...
  const generateMessage = () => {
    const riskIcon = riskStatus === 'Bahaya' ? '🔴' : riskStatus === 'Waspada' ? '🟡' : '🟢';
...
Melalui Sistem Informasi Monitoring Akademik Terintegrasi, kami sampaikan laporan perkembangan kedisiplinan putra/putri Bapak/Ibu:
...
• ❌ Alpha (Tanpa Keterangan) : ${stats.alpha} hari
• 🤒 Sakit : ${stats.sick} hari
• 📩 Izin : ${stats.permission} hari

${riskIcon} *Status Monitoring:* *${riskStatus?.toUpperCase() || 'AMAN'}*

Mohon perhatian dan kerjasamanya untuk melakukan pembinaan di rumah demi kelancaran proses belajar mengajar. Apabila diperlukan, Bapak/Ibu dapat berkonsultasi langsung ke Ruang BK pada jam kerja.
...
Hormat Kami,
*Tim Bimbingan Konseling (BK)*
_Generated by System on: ${today}_
`.trim();
  };

  const handleWhatsAppClick = () => {
    if (!student.parentPhone || student.parentPhone === '-' || student.parentPhone.length < 5) {
        alert("Nomor WhatsApp Wali Murid belum terdaftar atau tidak valid.");
        return;
    }
                    ...
                    <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm h-fit">
                        ...
                        <div className="space-y-4 text-sm">
                            <div className="flex items-start gap-3">
                                <WhatsAppLogo className="w-5 h-5 text-green-500 mt-0.5" />
                                <div>
                        ...
                        <div className="mt-6 pt-4 border-t border-gray-100 flex gap-2">
                            <Button 
                                ...
                                className="bg-green-50 text-green-700 hover:bg-green-100 border border-green-200 flex-1"
                            >
                                <WhatsAppLogo className="w-4 h-4 mr-2" /> Hubungi via WhatsApp
                            </Button>
                            <Button 
                                variant="outline" 
