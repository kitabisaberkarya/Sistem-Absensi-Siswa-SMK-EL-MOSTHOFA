...
export const StudentViolationDetailModal: React.FC<Props> = ({ isOpen, onClose, student, riskStatus = 'Aman' }) => {
  ...
  const handleWhatsAppClick = () => {
    ...
    // 2. Determine Severity Icon
    const riskIcon = riskStatus === 'Bahaya' ? '🔴' : riskStatus === 'Waspada' ? '🟡' : '🟢';
    
    // 3. Current Date
    const today = new Date().toLocaleDateString('id-ID', { weekday: 'long', day: 'numeric', month: 'long', year: 'numeric' });

    // 4. Construct Professional Message (Ministry Standard 2026 Style)
    const message = `
...
${riskIcon} *Status Monitoring:* *${riskStatus.toUpperCase()}*
